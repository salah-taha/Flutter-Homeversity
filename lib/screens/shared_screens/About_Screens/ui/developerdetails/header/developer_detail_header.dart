...
class DeveloperDetailHeader extends StatelessWidget {
  static const BACKGROUND_IMAGE = 'images/BK.jpg';
  ...
  Widget _buildAvatar() {
    return new Hero(
      ...
      child: new CircleAvatar(
        backgroundImage: new NetworkImage(developer.avatar),
        radius: 50.0,
      ),
    );
  }
  ...
  Widget _buildFollowerInfo(TextTheme textTheme) {
    ...
    return new Padding(
      ...
      child: new Row(
        ...
        children: <Widget>[
          new Text('21 years old', style: followerStyle),
          new Text(
            ' | ',
            style: followerStyle.copyWith(
                fontSize: 24.0, fontWeight: FontWeight.normal),
          ),
          new Text('01155400075', style: followerStyle),
        ],
      ),
    );
  }
